...
# -*- coding: utf-8 -*-
"""
🏦 Institutional Analyst Persona: US 13F Holdings Analysis
============================================================
Analyzes institutional ownership and insider trading activity:
- Institutional ownership percentage
- Insider buy/sell activity
- Short interest levels
- Overall institutional sentiment score

Author: Institutional Analyst Persona
Purpose: Track smart money movements and institutional confidence
"""
...
class SEC13FAnalyzer:
    """
    SEC 13F 기반 기관 보유량 및 인사이더 매매 분석
    
    분석 요소:
    - 기관 보유 비율: 높을수록 기관 관심 ↑
    - 인사이더 매매: 내부자 매수 = 긍정 신호
    - 공매도 비율: 높을수록 베어리시
    
    Note: 13F 공시는 분기별, 45일 지연
    """
