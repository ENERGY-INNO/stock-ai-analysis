...
# -*- coding: utf-8 -*-
"""
🏗️ Data Engineer Persona: US Stock Daily Prices Collection Script
===================================================================
Collects daily price data for S&P 500 stocks using yfinance
Supports incremental updates to avoid redundant API calls

Author: Data Engineer Persona
Purpose: Build reliable data pipeline for US stock price collection
"""
...
class USStockDailyPricesCreator:
    """
    S&P 500 종목의 일일 가격 데이터를 수집하는 클래스
    
    Features:
    - 503개 S&P 500 종목 지원
    - 증분 업데이트 (기존 데이터 이후만 수집)
    - 전체 새로고침 옵션
    """
